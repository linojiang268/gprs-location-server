 ...
 */
class ChinaMobile extends UuidModel
{
    use SoftDeletes;
    ...
    /**
     * Shape a base station of china mobile
     *
     * @param int $lac
     * @param int $cellId
     * @param $lat
    ...
    /**
     * Find base station of china mobile
     *
     * @param int $lac
     * @param int $cellId
     * @return static|null
